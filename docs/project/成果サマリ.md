...
| 「オンライン学習（RLS）」を動かしたい | RLS更新を回して delay別R² を出し、repeats→レポート化まで一通り動く | [outputs/phase2/rls/reports/phase2_rls_online_repeats5_v3_report.md](../../outputs/phase2/rls/reports/phase2_rls_online_repeats5_v3_report.md) |
...
- `state_mode=v+spike`, `proj_out_dim=200`, `update_every=1`, `lam=1`, `delta=0.01` で
...
- 逆に、更新頻度を落とす（例: 10–50ms）と崩れるなど、次に取り組むべき課題も明確になった

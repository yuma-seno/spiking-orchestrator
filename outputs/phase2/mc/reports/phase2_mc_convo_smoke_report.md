...
- 入力CSV: outputs/phase2/mc/runs/phase2_mc_convo_smoke.csv
- 総試行数: 1
- ユニーク条件数: 1
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--|---:|---:|---:|---:|
| 1 | 0.9496 | 0.0000 | 1 | 0.000000 | 200 | 1000 | 1.000 | 0.200 | spike | 1.000 | 0.500 | 0.000 | 0.000 |

## Best

- mean MC=0.9496 (std=0.0000, n_runs=1)
- mean spike_rate=0.000000
- tauF=200ms, tauD=1000ms, w_scale=1.000, U=0.200
- rec=spike, v_threshold=1.000

...
- 入力CSV: outputs/phase2/mc/runs/phase2_mc_spike_rate_smoke_dcbias1.csv
- 総試行数: 1
- ユニーク条件数: 1
...
- ニューロン数 n: 80
- ステップ数 steps: 1000（長いほど時間がかかる）
- washout: 100（最初の過渡を捨てる）
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--|---:|---:|---:|---:|
| 1 | 0.0000 | 0.0000 | 1 | 0.000000 | 100 | 500 | 1.000 | 0.200 | spike | 0.500 | 0.000 | 0.000 | 1.000 |

## Best

- mean MC=0.0000 (std=0.0000, n_runs=1)
- mean spike_rate=0.000000
- tauF=100ms, tauD=500ms, w_scale=1.000, U=0.200
- rec=spike, v_threshold=0.500
- input_scale=0.000, input_bias=0.000, dc_bias=1.000

...
- 入力CSV: outputs/phase2/mc/runs/phase2_mc_state_modes_smoke.csv
- 総試行数: 25
- ユニーク条件数: 5
...
- ridge（回帰の正則化）: 0.001
- sparsity（結合の疎さ）: 0.1
- Random Projection out_dim（0=full）: 0
- state_mode: spike, v, v+spike, v+spike+u+r+eff, v+u+r+eff
...
|---:|---:|---:|---:|---:|---:|:--|---:|---:|---:|---:|:--|---:|---:|---:|---:|
| 1 | 28.9926 | 2.3537 | 5 | 0.005269 | 0 | v+spike+u+r+eff | 200 | 1000 | 1.000 | 0.200 | spike | 0.250 | 0.500 | 0.000 | 0.250 |
| 2 | 21.2920 | 2.1039 | 5 | 0.005269 | 0 | v+u+r+eff | 200 | 1000 | 1.000 | 0.200 | spike | 0.250 | 0.500 | 0.000 | 0.250 |
| 3 | 19.6768 | 1.7173 | 5 | 0.005269 | 0 | v+spike | 200 | 1000 | 1.000 | 0.200 | spike | 0.250 | 0.500 | 0.000 | 0.250 |
| 4 | 9.9386 | 0.9484 | 5 | 0.005269 | 0 | v | 200 | 1000 | 1.000 | 0.200 | spike | 0.250 | 0.500 | 0.000 | 0.250 |
| 5 | 9.6527 | 0.7347 | 5 | 0.005269 | 0 | spike | 200 | 1000 | 1.000 | 0.200 | spike | 0.250 | 0.500 | 0.000 | 0.250 |

## Best

- mean MC=28.9926 (std=2.3537, n_runs=5)
